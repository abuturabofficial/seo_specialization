...
- [Introduction to Search Engine Algorithms](#introduction-to-search-engine-algorithms)
  - [MOZcast](#mozcast)
- [Algorithms Updates: History, Part 1](#algorithms-updates-history-part-1)
- [Algorithms Updates: History, Part 2](#algorithms-updates-history-part-2)
    - [Semantic Indexing](#semantic-indexing)
    - [Mobile Friendliness](#mobile-friendliness)
    - [Other Updates](#other-updates)
- [SEO Best Practices and Ranking Factors](#seo-best-practices-and-ranking-factors)
  - [Three Major Types of Ranking Factors](#three-major-types-of-ranking-factors)
- [Panda: The Game Changer for Content](#panda-the-game-changer-for-content)
  - [Targeted: Think/Low Quality Sites](#targeted-thinklow-quality-sites)
  - [Targeted: Duplicate Content](#targeted-duplicate-content)
  - [Targeted: Excessive Ads](#targeted-excessive-ads)
  - [Targeted: Poor Navigation](#targeted-poor-navigation)
  - [Others](#others)
- [Cleaning Up Links with Penguin](#cleaning-up-links-with-penguin)
  - [Penguin Targets: Link networks](#penguin-targets-link-networks)
  - [Penguin Targets: Link Trading](#penguin-targets-link-trading)
  - [Penguin Targets: Comment spam](#penguin-targets-comment-spam)
  - [Penguin Targets: Bad anchor text](#penguin-targets-bad-anchor-text)
  - [Penguin Targets: Paid Links](#penguin-targets-paid-links)
  - [Penguin Targets: Irrelevant links](#penguin-targets-irrelevant-links)
    - [Poor Linkbuilding](#poor-linkbuilding)
...
- Look for case studies, how algorithm changes effected the different websites.
...
- Penguin aims to stop spammy links, is re-ran periodically.
